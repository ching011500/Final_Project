...
補充2:
-每次課程顯示最多10筆(有10筆以上則顯示10筆，小於10筆則顯示全部)，若10筆顯示完還未顯示完整，則在後面告知還有未顯示的課程。
-當使用者回覆繼續顯示，則繼續依上面的規則顯示。
-直到所有課程顯示完，要在最後告知已顯示完。
-若課程總數超過30筆，則依上述方式顯示到第30筆，並在最後告知雖有未顯示的課程，但要求使用者調整提問方式，避免查詢範圍過大。
