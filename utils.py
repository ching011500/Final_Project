...
def extract_time_from_query(query: str) -> Dict[str, Optional[str]]:
    ...
    # 提取星期幾
    day_patterns = {
        '週一': '週一', '星期一': '週一', 'Monday': '週一', 'Mon': '週一',
        '週二': '週二', '星期二': '週二', 'Tuesday': '週二', 'Tue': '週二',
        '週三': '週三', '星期三': '週三', 'Wednesday': '週三', 'Wed': '週三',
        '週四': '週四', '星期四': '週四', 'Thursday': '週四', 'Thu': '週四',
        '週五': '週五', '星期五': '週五', 'Friday': '週五', 'Fri': '週五',
        '週六': '週六', '星期六': '週六', 'Saturday': '週六', 'Sat': '週六',
        '週日': '週日', '星期日': '週日', 'Sunday': '週日', 'Sun': '週日',
    }
